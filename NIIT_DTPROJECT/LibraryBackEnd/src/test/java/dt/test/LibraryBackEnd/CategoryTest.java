...
public class CategoryTest {
	...
	public void retrieveCategoryTest() {
		List<Category> clist = categorydao.retrieveCategory();
		assertNotNull(clist);
		this.show(clist);
	}
...
*/
	...
	public void getCategoryTest() {
		Category category2 = categorydao.getCategory(1);
		assertNotNull("prbm in getting data" + category2);
	 ...
	 */
	 ...
	 @Test public void updateCategoryTest() { category.setCid(1);
	 category.setCname("Bed Time Stories");
